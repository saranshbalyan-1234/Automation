...
export default function Parameter({ currentEvent }) {
  return (
    <>
      ...
      {currentEvent.parameter5 && (
        <Form.Item
          label={<div className="star">{currentEvent.parameter5}</div>}
        >
          <Form.Item
            name="type5"
            rules={[
          ...
          >
            {currentEvent.parameter5 === "Button" ? (
              <Select style={{ minWidth: "160px" }} showSearch>
                {KeyboardButtonList.map((el, i) => {
                  return (
                    <Option value={el} key={i}>
            ...
            ) : currentEvent.parameter5 === "Condition" ? (
              <Select style={{ minWidth: "160px" }} showSearch>
                {ConditionList.map((el, i) => {
                  return (
                    <Option value={el} key={i}>
              ...
              <Input name="parameter5" showCount maxLength={50} />
            )}
          </Form.Item>
        </Form.Item>
      )}
